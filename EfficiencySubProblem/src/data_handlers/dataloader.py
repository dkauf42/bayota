...
class DataLoader:
    def __init__(self, save2file=True, geolist=None):
        ...
        TblBmpGroup = self.jeeves.source.TblBmpGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpGroup.csv'))
        TblBmpLoadSourceGroup = self.jeeves.source.TblBmpLoadSourceGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpLoadSourceGroup.csv'))
        TblBmpType = self.jeeves.source.TblBmpLoadSourceGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpType.csv'))

        TblLoadSource = self.jeeves.source.TblLoadSource.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLoadSource.csv'), skipinitialspace=True)
        ...
        TblLandRiverSegment = self.jeeves.source.TblLandRiverSegment.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLandRiverSegment.csv'))

        TblGeography = self.jeeves.source.TblGeography.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeography.csv'))
        TblGeographyLrSeg = self.jeeves.source.TblGeographyLrSeg.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeographyLrSeg.csv'))
        TblGeographyType = self.jeeves.source.TblGeographyType.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeographyType.csv'))

        # Data tables for the parameter definitions
        TblBmpEfficiency = self.jeeves.source.TblBmpEfficiency.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpEfficiency.csv'))
        # Target load reductions ???  (set this ourselves??)
        TblLandUsePreBmp = self.jeeves.source.TblLandUsePreBmp.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLandUsePreBmp.csv'))
        TblCostBmpLand = self.jeeves.meta.TblCostBmpLand.copy()  # pd.read_csv(os.path.join(metadatadir, 'TblCostBmpLand.csv'))
