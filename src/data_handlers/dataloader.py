...
class DataLoader:
    def __init__(self, save2file=True, geolist=None):
        ...
        TblBmp = self.jeeves.bmp.source.TblBmp.copy()  #  pd.read_csv(os.path.join(sourcedatadir, 'TblBmp.csv'))
        TblBmpGroup = self.jeeves.bmp.source.TblBmpGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpGroup.csv'))
        TblBmpLoadSourceGroup = self.jeeves.bmp.source.TblBmpLoadSourceGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpLoadSourceGroup.csv'))
        TblBmpType = self.jeeves.bmp.source.TblBmpLoadSourceGroup.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpType.csv'))

        TblLoadSource = self.jeeves.loadsource.source.TblLoadSource.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLoadSource.csv'), skipinitialspace=True)
        ...
        TblLandRiverSegment = self.jeeves.lrseg.source.TblLandRiverSegment.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLandRiverSegment.csv'))

        TblGeography = self.jeeves.geo.source.TblGeography.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeography.csv'))
        TblGeographyLrSeg = self.jeeves.geo.source.TblGeographyLrSeg.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeographyLrSeg.csv'))
        TblGeographyType = self.jeeves.geo.source.TblGeographyType.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblGeographyType.csv'))

        # Data tables for the parameter definitions
        TblBmpEfficiency = self.jeeves.bmp.source.TblBmpEfficiency.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblBmpEfficiency.csv'))
        # Target load reductions ???  (set this ourselves??)
        TblLandUsePreBmp = self.jeeves.bmp.source.TblLandUsePreBmp.copy()  # pd.read_csv(os.path.join(sourcedatadir, 'TblLandUsePreBmp.csv'))
        TblCostBmpLand = self.jeeves.bmp.meta.TblCostBmpLand.copy()  # pd.read_csv(os.path.join(metadatadir, 'TblCostBmpLand.csv'))
        Tbl2010NoActionLoads = pd.read_csv(os.path.join(get_datadir(), '2010NoActionLoads.csv'))
        ...
        singlelsgrpdf = pd.read_csv(os.path.join(get_datadir(), 'single-ls_groups.csv'))
