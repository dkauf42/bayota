...
filename = 'output/loadobj_startingpoint9_costbound100000_ipopt_2018-08-07_121054.iters'
...
filenamestr = ''.join(['output/loadobj_iterates_summaryobj_zoomed_randomstart_', 'ipopt', '_',
...
filenamestr = ''.join(['output/loadobj_iterates_summary_randomstart_', 'ipopt', '_',
                           datetime.now().strftime('%Y-%m-%d_%H%M%S'), '.png'])
savefilepathandname = os.path.join(projectpath, filenamestr)
plt.savefig(savefilepathandname)
...
filenamestr = ''.join(['output/loadobj_heatmap_iterates_variables_randomstart_', 'ipopt', '_',
                           datetime.now().strftime('%Y-%m-%d_%H%M%S'), '.png'])
savefilepathandname = os.path.join(projectpath, filenamestr)
...
plt.xlabel("iterate (max % load reduction achieved)")
