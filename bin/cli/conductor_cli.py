...
Example Usage:
    ...
    >>> ./bin/conductor_cli.py -o costmin -s county -e "Adams, PA" "Lancaster, PA"
    
    # Just config file argument values
    >>> ./bin/conductor_cli.py -f study_config.ini
    
    # With a configuration file and command line arguments:
    >>> ./bin/conductor_cli.py -f study_config.ini -s county -e "Adams, PA" "Lancaster, PA"
"""
import os
import sys
import ast
...
def main(args):
    ...
    if args.command == 'createinstance':
...
if __name__ == '__main__':
    ...
    # Configuration file entries are read to update default values.
    if opts.conf_file:
        config = ConfigParser()
    ...
    # Make subparsers for "conductor.py createinstance ..." and "conductor.py solveinstance ..."
    ...
    createinstance_parser.add_argument('-y', '--baseyear', dest='baseyear',
                                       type=str,
