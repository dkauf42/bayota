...
# model_spec = '/Users/Danny/Desktop/CATEGORIES/CAREER_MANAGEMENT/CRC_ResearchScientist_Optimization/Optimization_Tool/2_ExperimentFolder/bayota/bin/specification_files/model_specs/Nloadreductionmax_totalcostupper.yaml'
# mdlhandler = model_generator.ModelBuilder(model_spec=model_spec,
#                                               geoscale='county',
